$(document).ready(function() {
  ...
  /*Should set todays date in the cal so that it doesnt show old dates to begin with!!*/
  ...
  $('.date-picker').each(function () {
    ...
    function updateDisplay(cur_date) {
      dateString = cur_date.format("YYYY-MM-DD");
      if(text_id == 'to-date') {
        document.getElementById("endDate").textContent = dateString;
      }
      else {
        document.getElementById("startDate").textContent = dateString;
      }
